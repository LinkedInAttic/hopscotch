define("hopscotch", [], function() { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var Hopscotch = void 0,
    HopscotchBubble = void 0,
    HopscotchCalloutManager = void 0,
    HopscotchI18N = void 0,
    customI18N = void 0,
    customRenderer = void 0,
    customEscape = void 0,
    ...
    if (utils.documentIsReady()) {
      ...
      if (doc.addEventListener) {
        _appendToBody2 = function appendToBody() {
          doc.removeEventListener('DOMContentLoaded', _appendToBody2);
          window.removeEventListener('load', _appendToBody2);

          doc.body.appendChild(el);
        };

        doc.addEventListener('DOMContentLoaded', _appendToBody2, false);
      }
      // IE
      else {
          _appendToBody2 = function _appendToBody() {
            if (doc.readyState === 'complete') {
              doc.detachEvent('onreadystatechange', _appendToBody2);
              window.detachEvent('onload', _appendToBody2);
              doc.body.appendChild(el);
            }
          };

          doc.attachEvent('onreadystatechange', _appendToBody2);
        }
...
var _hopscotch = __webpack_require__(0);

var _hopscotch2 = _interopRequireDefault(_hopscotch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var hopscotch = new _hopscotch2.default();
