...
!a.target?null:"string"===typeof a.target?/^[#\.]/.test(a.target)?document.querySelector?document.querySelector(a.target):y?(a=jQuery(a.target),a.length?a[0]:null):D?(a=new D(a.target),a.length?a[0]:null):"#"===a.target[0]&&-1===a.target.indexOf(" ")?document.getElementById(a.target.substring(1)):null:document.getElementById(a.target):a.target},isArray:Array.isArray||function(a){return"number"===typeof a.length&&"function"===typeof a.unshift&&"function"===typeof a.push},setState:function(a,b,d){var e=
"";t?sessionStorage.setItem(a,b):(d&&(e=new Date,e.setTime(e.getTime()+864E5*d),e="; expires="+e.toGMTString()),document.cookie=a+"="+b+e+"; path=/")},getState:function(a){var b=a+"=",d=document.cookie.split(";"),e,f;if(t)f=sessionStorage.getItem(a);else for(a=0;a<d.length;a++){for(e=d[a];" "===e.charAt(0);)e=e.substring(1,e.length);if(0===e.indexOf(b)){f=e.substring(b.length,e.length);break}}return f},clearState:function(a){t?sessionStorage.removeItem(a):this.setState(a,"",-1)}},p={next:[],prev:[],
start:[],end:[],show:[],error:[],close:[]},x={},m={stepNums:null,nextBtn:"Next",prevBtn:"Back",doneBtn:"Done",skipBtn:"Skip",closeTooltip:"Close"},w=function(a){this.init(a)},w.prototype={isShowing:!1,currStep:void 0,_createButton:function(a,c){var d=document.createElement("button");d.id=a;d.innerHTML=c;b.addClass(d,"hopscotch-nav-button");0<=a.indexOf("prev")?b.addClass(d,"prev"):b.addClass(d,"next");return d},setPosition:function(a){var c,d,e,f,h;e=b.getStepTarget(a);var g=this.element,i=this.arrowEl,
...
document.addEventListener?(g=function(){document.removeEventListener("DOMContentLoaded",g);document.body.appendChild(c)},document.addEventListener("DOMContentLoaded",g)):(g=function(){"complete"===document.readyState&&(document.detachEvent("onreadystatechange",g),document.body.appendChild(c))},document.attachEvent("onreadystatechange",g))}},C=function(){var a={};this.createCallout=function(b){var d;if(b.id){if(a[b.id])throw"Callout by that id already exists. Please choose a unique id.";b.isTourBubble=
!1;d=new w(b);a[b.id]=d;b.target&&d.render(b,null,null,function(){d.show()})}else throw"Must specify a callout id.";return d};this.getCallout=function(b){return a[b]};this.removeAllCallouts=function(){for(var b in a)a.hasOwnProperty(b)&&this.removeCallout(b)};this.removeCallout=function(b){var d=a[b];a[b]=null;d&&d.destroy()}},j=function(a){var c=this,d,e,f,h,g,i,k,j,u=function(){d||(d=new w({animate:f.animate,bubblePadding:f.bubblePadding,bubbleWidth:f.bubbleWidth,showNextButton:f.showNextButton,
showPrevButton:f.showPrevButton,arrowWidth:f.arrowWidth}));return d},q=function(){return 0>g||g>=h.steps.length?null:h.steps[g]},t=function(){c.nextStep(!1)},z=function(a,f){var r,d;0<=g+a&&g+a<h.steps.length?(g+=a,d=q(),setTimeout(function(){(r=b.getStepTarget(d))?f(g):(b.invokeEventCallbacks("error"),z(a,f))},b.valOrDefault(d.delay,0))):f(-1)},v=function(a,d){var r=this,e,c,i,A;u().hide();a=b.valOrDefault(a,!0);c=e=q();i=e.multipage;A=function(f){if(-1===f)return this.endTour(!0);if(a&&(0<d&&c.onNext?
b.invokeCallback(c.onNext):0>d&&c.onPrev&&b.invokeCallback(c.onPrev),b.invokeEventCallbacks(0<d?"next":"prev"),0<d&&i))return;this.showStep(f)};if(!i&&f.skipIfNoElement)z(d,function(a){A.call(r,a)});else if(0<=g+d&&g+d<h.steps.length){g+=d;e=q();if(!b.getStepTarget(e)&&!i)return b.invokeEventCallbacks("error"),this.endTour(!0,!1);A.call(this,g)}return this};this.getCalloutManager=function(){"undefined"===typeof e&&(e=new C);return e};this.startTour=function(a,d){var c;if(!h){c={};var e;h=a;for(e in a)a.hasOwnProperty(e)&&
("id"!==e&&"steps"!==e)&&(c[e]=a[e]);this.resetDefaultOptions();j.call(this,c,!0);if(c=b.getState(f.cookieName))c=c.split(":"),i=c[0],k=c[1],k=parseInt(k,10),2<c.length&&"mp"===c[2]&&k<h.steps.length-1&&++k}"undefined"!==typeof d&&(g=d);if("complete"!==document.readyState)return E=!0,this;if("undefined"===typeof g)if(h.id===i&&"undefined"!==typeof k){if(g=k,c=q(),c=b.getStepTarget(c),c||(--g,c=q(),c=b.getStepTarget(c)),!c&&f.skipIfNoElement&&(z(1),c=-1!==g&&b.getStepTarget(h.steps[g])),!c)return this.endTour(!1,
!1),this}else g=0;b.invokeEventCallbacks("start");c=u();c.hide(!1);this.isActive=!0;f.animate&&c._initAnimate();b.getStepTarget(q())?this.showStep(g):(b.invokeEventCallbacks("error"),f.skipIfNoElement&&this.nextStep(!1));return this};this.showStep=function(a){var c=h.steps[a];setTimeout(function(){var d=h.steps.length,e=h.id+":"+a,i=u(),k=b.getStepTarget(c);g=a;f.animate||i.hide(!1);i.render(c,a,a===d-1,function(a){if(a){var d=function(){i.show()},e=u().element,a=b.getPixelValue(e.style.top),e=a+
b.getPixelValue(e.offsetHeight),g=b.getStepTarget(q()).getBoundingClientRect(),h=g.top+b.getScrollTop(),g=g.bottom+b.getScrollTop(),a=a<h?a:h,e=e>g?e:g,h=b.getScrollTop(),g=h+b.getWindowHeight(),n=a-f.scrollTopMargin,r,F,j;a>=h&&(a<=h+f.scrollTopMargin||e<=g)?d&&d():f.smoothScroll?"undefined"!==typeof YAHOO&&"undefined"!==typeof YAHOO.env&&"undefined"!==typeof YAHOO.env.ua&&"undefined"!==typeof YAHOO.util&&"undefined"!==typeof YAHOO.util.Scroll?(a=YAHOO.env.ua.webkit?document.body:document.documentElement,
e=YAHOO.util.Easing?YAHOO.util.Easing.easeOut:void 0,a=new YAHOO.util.Scroll(a,{scroll:{to:[0,n]}},f.scrollDuration/1E3,e),a.onComplete.subscribe(d),a.animate()):y?$("body, html").animate({scrollTop:n},f.scrollDuration,d):(0>n&&(n=0),r=h>a?-1:1,F=Math.abs(h-n)/(f.scrollDuration/10),j=function(){var a=b.getScrollTop(),c=a+r*F;0<r&&c>=n||0>r&&c<=n?(c=n,d&&d(),window.scrollTo(0,c)):(window.scrollTo(0,c),b.getScrollTop()===a?d&&d():setTimeout(j,10))},j()):(window.scrollTo(0,n),d&&d())}else i.show();c.onShow&&
b.invokeCallback(c.onShow);c.nextOnTargetClick&&b.addClickListener(k,t)});b.invokeEventCallbacks("show");c.multipage&&(e+=":mp");b.setState(f.cookieName,e,1)},c.delay||0);return this};this.prevStep=function(a){v.call(this,a,-1);return this};this.nextStep=function(a){var c=q(),d=b.getStepTarget(c);c.nextOnTargetClick&&b.removeClickListener(d,t);v.call(this,a,1);return this};this.endTour=function(a,c){var d=u(),a=b.valOrDefault(a,!0),c=b.valOrDefault(c,!0);g=0;k=void 0;d.hide();a&&b.clearState(f.cookieName);
l.isActive=!1;h&&c&&b.invokeEventCallbacks("end");l.removeCallbacks(!0);h=null;return this};this.getCurrTour=function(){return h};this.getCurrStepNum=function(){return g};this.listen=function(a,b,c){a&&p[a].push({cb:b,fromTour:c});return this};this.unlisten=function(a,b){var c=p[a],d,e;d=0;for(e=c.length;d<e;++d)c[d]===b&&c.splice(d,1)};this.removeCallback=function(a,b){var c=p[a],d,e;d=0;for(e=c.length;d<e;++d)b===c[d].cb&&c.splice(d,1);return this};this.removeCallbacks=function(a){var b,c,d,e;for(e in p)if(a){b=
p[e];c=0;for(d=b.length;c<d;++c)b[c].fromTour&&(b.splice(c--,1),--d)}else p[e]=[];return this};this.registerHelper=function(a,b){"string"===typeof a&&"function"===typeof b&&(x[a]=b)};this.unregisterHelper=function(a){x[a]=null};this.setCookieName=function(a){f.cookieName=a;return this};this.resetDefaultOptions=function(){f||(f={});b.extend(f,s);return this};j=function(a,c){var d;d="next prev start end show error close".split(" ");var e,g,h;f||this.resetDefaultOptions();b.extend(f,a);a&&b.extend(m,
a.i18n);g=0;for(h=d.length;g<h;++g)e="on"+d[g][0].toUpperCase()+d[g].substring(1),a[e]&&this.listen(d[g],a[e],c);d=u();f.animate?d._initAnimate():d._removeAnimate();d.showCloseButton(a.showCloseButton,"undefined"!==typeof a.showCloseButton);return this};this.configure=function(a){return j.call(this,a,!1)};a&&(a.cookieName=a.cookieName||"hopscotch.tour.state",this.configure(a))},l=new j,v[B]=l)})(window,"hopscotch");
