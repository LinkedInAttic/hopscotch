...
"",l.style.top=i+"px"}else l.style.top="",l.style.left="";f+=b.getPixelValue(a.xOffset);h+=b.getPixelValue(a.yOffset);a.fixedElement||(h+=b.getScrollTop(),f+=b.getScrollLeft());g.style.position=a.fixedElement?"fixed":"absolute";this.opt.animate&&C&&!t?$(g).animate({top:h+"px",left:f+"px"}):(g.style.top=h+"px",g.style.left=f+"px")},_initNavButtons:function(){var a=f.createElement("div");this.prevBtnEl=this._createButton("hopscotch-prev",n.prevBtn);this.nextBtnEl=this._createButton("hopscotch-next",
...
return this},_getCloseFn:function(){var a=this;this.closeFn||(this.closeFn=function(e){a.opt.onClose&&b.invokeCallback(a.opt.onClose);a.opt.id&&!a.opt.isTourBubble?m.getCalloutManager().removeCallout(a.opt.id):a.destroy();b.evtPreventDefault(e)});return this.closeFn},initCloseButton:function(){var a=f.createElement("a");a.className="hopscotch-bubble-close";a.href="#";a.title=n.closeTooltip;a.innerHTML=n.closeTooltip;this.opt.isTourBubble?b.addClickListener(a,function(a){var c=m.getCurrStepNum(),d=
m.getCurrTour(),c=c===d.steps.length-1;b.invokeEventCallbacks("close");m.endTour(!0,c);a.preventDefault?a.preventDefault():event&&(event.returnValue=!1)}):b.addClickListener(a,this._getCloseFn());this.closeBtnEl=a;this.containerEl.appendChild(a);return this},_initArrow:function(){var a,b;this.arrowEl=f.createElement("div");this.arrowEl.className="hopscotch-bubble-arrow-container";b=f.createElement("div");b.className="hopscotch-bubble-arrow-border";a=f.createElement("div");a.className="hopscotch-bubble-arrow";
this.arrowEl.appendChild(b);this.arrowEl.appendChild(a);this.element.appendChild(this.arrowEl);return this},render:function(a,e,c,d){var h=this.element,f,g;a?this.currStep=a:this.currStep&&(a=this.currStep);f=b.valOrDefault(a.showNextButton,this.opt.showNextButton);g=b.valOrDefault(a.showPrevButton,this.opt.showPrevButton);this.setTitle(a.title||"");this.setContent(a.content||"");this.opt.showNumber&&this.setNum(e);this.orientation=a.orientation;this.showPrevButton(this.prevBtnEl&&g&&0<e);this.showNextButton(this.nextBtnEl&&
f&&!c);this.nextBtnEl.value=a.showSkip?n.skipBtn:n.nextBtn;c?b.removeClass(this.doneBtnEl,"hide"):b.addClass(this.doneBtnEl,"hide");this._showButton(this.ctaBtnEl,!!a.showCTAButton);a.showCTAButton?(this.ctaBtnEl.innerHTML=a.ctaLabel,a.onCTA&&(this.onCTA&&b.removeClickListener(this.ctaBtnEl,this.onCTA),b.addClickListener(this.ctaBtnEl,a.onCTA),this.onCTA=a.onCTA)):this.onCTA&&(b.removeClickListener(this.ctaBtnEl,this.onCTA),this.onCTA=null);this._setArrow(a.orientation);e=b.getPixelValue(a.width)||
...
f.createElement("div"),c=f.createElement("div"),d=f.createElement("div"),h=this,j=!1,g,l;this.element=e;this.containerEl=c;this.titleEl=f.createElement("h3");this.contentEl=f.createElement("p");l={animate:u.animate,showPrevButton:u.showPrevButton,showNextButton:u.showNextButton,bubbleWidth:u.bubbleWidth,bubblePadding:u.bubblePadding,arrowWidth:u.arrowWidth,showNumber:!0,isTourBubble:!0};a="undefined"===typeof a?{}:a;b.extend(l,a);this.opt=l;e.className="hopscotch-bubble animated";c.className="hopscotch-bubble-container";
l.showNumber?(this.numberEl=f.createElement("span"),this.numberEl.className="hopscotch-bubble-number",c.appendChild(this.numberEl)):b.addClass(e,"no-number");d.appendChild(this.titleEl);d.appendChild(this.contentEl);d.className="hopscotch-bubble-content";c.appendChild(d);e.appendChild(c);this._initNavButtons();this.initCloseButton();this._initArrow();a=function(){!j&&h.isShowing&&(j=!0,setTimeout(function(){h.setPosition(h.currStep);j=!1},100))};window.addEventListener?window.addEventListener("resize",
a,!1):window.attachEvent&&window.attachEvent("onresize",a,!1);this.hide();b.documentIsReady()?(f.body.appendChild(e),t=b.supportsCssTransitions()):f.addEventListener?(g=function(){f.removeEventListener("DOMContentLoaded",g);window.removeEventListener("load",g);f.body.appendChild(e);t=b.supportsCssTransitions()},f.addEventListener("DOMContentLoaded",g,!1),window.addEventListener("load",g,!1)):(g=function(){"complete"===f.readyState&&(f.detachEvent("onreadystatechange",g),window.detachEvent("onload",
g),f.body.appendChild(e));t=b.supportsCssTransitions()},f.attachEvent("onreadystatechange",g),window.attachEvent("onload",g))}},F=function(){var a={};this.createCallout=function(b){var c;if(b.id){if(a[b.id])throw"Callout by that id already exists. Please choose a unique id.";b.showNextButton=b.showPrevButton=!1;b.isTourBubble=!1;c=new A(b);a[b.id]=c;b.target&&c.render(b,null,null,function(){c.show()})}else throw"Must specify a callout id.";return c};this.getCallout=function(b){return a[b]};this.removeAllCallouts=
function(){for(var b in a)a.hasOwnProperty(b)&&this.removeCallout(b)};this.removeCallout=function(b){var c=a[b];a[b]=null;c&&c.destroy()}},p=function(a){var e=this,c,d,h,j,g,l,i,p,y=function(){c||(c=new A({animate:h.animate,bubblePadding:h.bubblePadding,bubbleWidth:h.bubbleWidth,showNextButton:h.showNextButton,showPrevButton:h.showPrevButton,arrowWidth:h.arrowWidth}));return c},r=function(){return 0>g||g>=j.steps.length?null:j.steps[g]},t=function(){e.nextStep(!1)},v=function(a,c){var d,h;0<=g+a&&
g+a<j.steps.length?(g+=a,h=r(),setTimeout(function(){(d=b.getStepTarget(h))?c(g):(b.invokeEventCallbacks("error"),v(a,c))},b.valOrDefault(h.delay,0))):c(-1)},z=function(a,c){var d=this,f,e,k,D;y().hide();a=b.valOrDefault(a,!0);e=f=r();k=f.multipage;D=function(d){if(-1===d)return this.endTour(!0);if(a&&(0<c?b.invokeEventCallbacks("next",e.onNext):b.invokeEventCallbacks("prev",e.onPrev),0<c&&k))return;this.showStep(d)};if(!k&&h.skipIfNoElement)v(c,function(a){D.call(d,a)});else if(0<=g+c&&g+c<j.steps.length){g+=
c;f=r();if(!b.getStepTarget(f)&&!k)return b.invokeEventCallbacks("error"),this.endTour(!0,!1);D.call(this,g)}return this};this.getCalloutManager=function(){"undefined"===typeof d&&(d=new F);return d};this.startTour=function(a,c){var d,f=this;if(!j){j=a;var e={},k;for(k in a)a.hasOwnProperty(k)&&("id"!==k&&"steps"!==k)&&(e[k]=a[k]);this.resetDefaultOptions();p.call(this,e,!0);if(e=b.getState(h.cookieName))e=e.split(":"),l=e[0],i=e[1],i=parseInt(i,10),2<e.length&&"mp"===e[2]&&i<j.steps.length-1&&++i}"undefined"!==
typeof c&&(g=c);if(!b.documentIsReady())return H=!0,this;g=j.id===l&&"undefined"!==typeof i?i:0;e=function(a){-1!==a&&b.getStepTarget(j.steps[a])?(b.invokeEventCallbacks("start"),d=y(),d.hide(!1),f.isActive=!0,h.animate&&d._initAnimate(),b.getStepTarget(r())?f.showStep(a):(b.invokeEventCallbacks("error"),h.skipIfNoElement&&f.nextStep(!1))):f.endTour(!1,!1)};g=g||0;k=r();(k=b.getStepTarget(k))?e(g):(0<g&&(--g,k=r(),k=b.getStepTarget(k)),k||(b.invokeEventCallbacks("error"),h.skipIfNoElement?(++g,v(1,
e)):(g=-1,e(g))));return this};this.showStep=function(a){var c=j.steps[a];setTimeout(function(){var d=j.steps.length,e=j.id+":"+a,w=y(),k=b.getStepTarget(c),i;i=function(){w.show();b.invokeEventCallbacks("show",c.onShow)};g=a;h.animate||w.hide(!1);w.render(c,a,a===d-1,function(a){if(a){var d=y().element,a=b.getPixelValue(d.style.top),d=a+b.getPixelValue(d.offsetHeight),e=b.getStepTarget(r()).getBoundingClientRect(),g=e.top+b.getScrollTop(),e=e.bottom+b.getScrollTop(),a=a<g?a:g,d=d>e?d:e,g=b.getScrollTop(),
