...
function(){i.nextStep(!0)});b.addClickListener(this.doneBtnEl,i.endTour);a.className="hopscotch-actions";this.buttonsEl=a;this.containerEl.appendChild(a);return this},_getCloseFn:function(){var a=this;this.closeFn||(this.closeFn=function(b){a.opt.id&&!a.opt.isTourBubble?i.getCalloutManager().removeCallout(a.opt.id):a.destroy();b.preventDefault?b.preventDefault():event&&(event.returnValue=!1)});return this.closeFn},initCloseButton:function(){var a=document.createElement("a");a.className="hopscotch-bubble-close";
