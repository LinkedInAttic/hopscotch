...
e+"px";this.containerEl.style.padding=c+"px";f.style.zIndex=a.zindex?a.zindex:"";"top"===a.orientation?(f.style.top="-9999px",f.style.left="-9999px",b.removeClass(f,"hide"),this.setPosition(a),b.addClass(f,"hide")):this.setPosition(a);d&&!a.fixedElement?d():this.show();return this},setTitle:function(a){a?(this.titleEl.innerHTML=a,b.removeClass(this.titleEl,"hide")):b.addClass(this.titleEl,"hide");return this},setContent:function(a){a?(this.contentEl.innerHTML=a,b.removeClass(this.contentEl,"hide")):
b.addClass(this.contentEl,"hide");return this},setNum:function(a){a=l.stepNums&&a<l.stepNums.length?l.stepNums[a]:a+1;this.numberEl.innerHTML=a},_setArrow:function(a){b.removeClass(this.arrowEl,"down up right left");"top"===a?b.addClass(this.arrowEl,"down"):"bottom"===a?b.addClass(this.arrowEl,"up"):"left"===a?b.addClass(this.arrowEl,"right"):"right"===a&&b.addClass(this.arrowEl,"left")},_getArrowDirection:function(){if("top"===this.orientation)return"down";if("bottom"===this.orientation)return"up";
...
0))):d(-1)},u=function(a,d){var c=this,e,i,j;s().hide();a=b.valOrDefault(a,!0);e=n();i=g;j=function(c){if(-1===c)return this.endTour(!0);if(a){if(0<d&&e.onNext)e.onNext();else if(0>d&&e.onPrev)e.onPrev();b.invokeCallbacks(0<d?"next":"prev",[h.id,i])}this.showStep(c)};if(f.skipIfNoElement)y(d,function(a){j.call(c,a)});else if(0<=g+d&&g+d<h.steps.length){g+=d;e=n();if(!b.getStepTarget(e))return b.invokeCallbacks("error",[h.id,g]),this.endTour(!0,!1);this.changeStepCb(g)}return this};this.getCalloutManager=
