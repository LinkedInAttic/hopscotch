...
b=document.createElement("div");b.className="hopscotch-bubble-arrow-border";a=document.createElement("div");a.className="hopscotch-bubble-arrow";this.arrowEl.appendChild(b);this.arrowEl.appendChild(a);this.element.appendChild(this.arrowEl);return this},render:function(a,e,c,d){var f=this.element,h,g;a?this.currStep=a:this.currStep&&(a=this.currStep);h=b.valOrDefault(a.showNextButton,this.opt.showNextButton);g=b.valOrDefault(a.showPrevButton,this.opt.showPrevButton);this.setTitle(a.title?a.title:"");
this.setContent(a.content?a.content:"");this.opt.showNumber&&this.setNum(e);this.orientation=a.orientation;this.opt.showNavButtons&&(this.showPrevButton(this.prevBtnEl&&g&&0<e),this.showNextButton(this.nextBtnEl&&h&&!c),this.nextBtnEl.value=a.showSkip?l.skipBtn:l.nextBtn,c?b.removeClass(this.doneBtnEl,"hide"):b.addClass(this.doneBtnEl,"hide"));this._setArrow(a.orientation);e=b.getPixelValue(a.width)||this.opt.bubbleWidth;c=b.valOrDefault(a.padding,this.opt.bubblePadding);this.containerEl.style.width=
e+"px";this.containerEl.style.padding=c+"px";f.style.zIndex=a.zindex?a.zindex:"";"top"===a.orientation?(f.style.top="-9999px",f.style.left="-9999px",b.removeClass(f,"hide"),this.setPosition(a),b.addClass(f,"hide"),d&&!a.fixedElement?d():this.show()):(this.setPosition(a),d&&!a.fixedElement?d():self.show());return this},setTitle:function(a){a?(this.titleEl.innerHTML=a,b.removeClass(this.titleEl,"hide")):b.addClass(this.titleEl,"hide");return this},setContent:function(a){a?(this.contentEl.innerHTML=
a,b.removeClass(this.contentEl,"hide")):b.addClass(this.contentEl,"hide");return this},setNum:function(a){a=l.stepNums&&a<l.stepNums.length?l.stepNums[a]:a+1;this.numberEl.innerHTML=a},_setArrow:function(a){b.removeClass(this.arrowEl,"down up right left");"top"===a?b.addClass(this.arrowEl,"down"):"bottom"===a?b.addClass(this.arrowEl,"up"):"left"===a?b.addClass(this.arrowEl,"right"):"right"===a&&b.addClass(this.arrowEl,"left")},_getArrowDirection:function(){if("top"===this.orientation)return"down";
...
b){this._showButton(this.nextBtnEl,a,b)},showCloseButton:function(a,b){this._showButton(this.closeBtnEl,a,b)},_initAnimate:function(){var a=this;setTimeout(function(){b.addClass(a.element,"animate")},50)},_removeAnimate:function(){b.removeClass(this.element,"animate")},destroy:function(){var a=this.element;a.parentNode.removeChild(a);b.removeClickListener(this.closeBtnEl,this._getCloseFn())},init:function(a){var e=document.createElement("div"),c=document.createElement("div"),d=document.createElement("div"),
f=this,h=!1;this.element=e;this.containerEl=c;this.titleEl=document.createElement("h3");this.contentEl=document.createElement("p");opt={animate:q.animate,showPrevButton:q.showPrevButton,showNextButton:q.showNextButton,bubbleWidth:q.bubbleWidth,bubblePadding:q.bubblePadding,arrowWidth:q.arrowWidth,showNumber:!0,showNavButtons:!0,isTourBubble:!0};a="undefined"===typeof a?{}:a;b.extend(opt,a);this.opt=opt;e.className="hopscotch-bubble animated";c.className="hopscotch-bubble-container";opt.showNumber?
(this.numberEl=document.createElement("span"),this.numberEl.className="hopscotch-bubble-number",c.appendChild(this.numberEl)):b.addClass(e,"no-number");d.appendChild(this.titleEl);d.appendChild(this.contentEl);d.className="hopscotch-bubble-content";c.appendChild(d);e.appendChild(c);opt.showNavButtons&&this._initNavButtons();this.initCloseButton();this._initArrow();a=function(){!h&&f.isShowing&&(h=!0,setTimeout(function(){f.setPosition(f.currStep);h=!1},100))};window.addEventListener?window.addEventListener("resize",
a,!1):window.attachEvent&&window.attachEvent("onresize",a,!1);this.hide();document.body.appendChild(e)}},z=function(){var a={};this.createCallout=function(b){var c;if(b.id){if(a[b.id])throw"Callout by that id already exists. Please choose a unique id.";b.isTourBubble=!1;c=new v(b);a[b.id]=c;b.target&&c.render(b)}else throw"Must specify a callout id.";};this.getCallout=function(b){return a[b]};this.removeAllCallouts=function(){for(var b in a)this.removeCallout(b)};this.removeCallout=function(b){var c=
a[b];a[b]=null;c&&c.destroy()}},k=function(a){var e=this,c,d,f,h,g,k,j,r,s=function(){c||(c=new v({animate:f.animate,bubblePadding:f.bubblePadding,bubbleWidth:f.bubbleWidth,showNextButton:f.showNextButton,showPrevButton:f.showPrevButton,arrowWidth:f.arrowWidth}));return c},n=function(){return 0>g||g>=h.steps.length?null:h.steps[g]},t=function(){e.nextStep(!1)},y=function(a,d){var f,c;0<=g+a&&g+a<h.steps.length?(g+=a,c=n(),setTimeout(function(){(f=b.getStepTarget(c))?d(g):(b.invokeCallbacks("error",
[h.id,g]),y(a,d))},b.valOrDefault(c.delay,0))):d(-1)},u=function(a,d){var c=this,e,i,j;s().hide();a=b.valOrDefault(a,!0);e=n();i=g;j=function(c){if(-1===c)return this.endTour(!0);if(a){if(0<d&&e.onNext)e.onNext();else if(0>d&&e.onPrev)e.onPrev();b.invokeCallbacks(0<d?"next":"prev",[h.id,i])}this.showStep(c)};if(f.skipIfNoElement)y(d,function(a){j.call(c,a)});else if(0<=g+d&&g+d<h.steps.length){g+=d;e=n();if(!b.getStepTarget(e))return b.invokeCallbacks("error",[h.id,g]),this.endTour(!0,!1);this.changeStepCb(g)}return this};
